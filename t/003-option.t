...
is($gen->data, "\x01\x02", 'Generic data');
...
is($gen_parsed->data, "\x01\x02", 'Generic parsed data');
...
ok(dies { Net::DHCPv6::Option::ClientId->new },
   'ClientId dies without duid');
ok(dies { Net::DHCPv6::Option::ClientId::from_bytes_inner(undef, 1, "\x00\x01") },
...
ok(dies { Net::DHCPv6::Option::ServerId->new },
   'ServerId dies without duid');
ok(dies { Net::DHCPv6::Option::ServerId::from_bytes_inner(undef, 2, "\x00\x01") },
...
ok(dies { Net::DHCPv6::Option::ORO::from_bytes_inner(undef, 6, "\x01") },
   'ORO dies on odd-length data');
...
ok(dies { Net::DHCPv6::Option::Preference->new },
   'Preference dies without value');
ok(dies { Net::DHCPv6::Option::Preference::from_bytes_inner(undef, 7, "\x01\x02") },
...
ok(dies { Net::DHCPv6::Option::ElapsedTime->new },
   'ElapsedTime dies without centiseconds');
ok(dies { Net::DHCPv6::Option::ElapsedTime::from_bytes_inner(undef, 8, "\x01") },
...
ok(dies { Net::DHCPv6::Option::StatusCode->new },
   'StatusCode dies without status_code');
ok(dies { Net::DHCPv6::Option::StatusCode::from_bytes_inner(undef, 13, "\x00") },
...
ok(dies { Net::DHCPv6::Option::RapidCommit::from_bytes_inner(undef, 14, "\x01") },
...
ok(dies { Net::DHCPv6::Option::IANA->new },
   'IANA dies without iaid');
ok(dies { Net::DHCPv6::Option::IANA::from_bytes_inner(undef, 3, "\x01" x 11) },
...
is($iaaddr->address, $addr, 'IAAddr address');
...
is($iaaddr_parsed->address, $addr, 'IAAddr parsed address');
...
ok(dies { Net::DHCPv6::Option::IAAddr->new },
   'IAAddr dies without address');
ok(dies { Net::DHCPv6::Option::IAAddr::from_bytes_inner(undef, 5, "\x01" x 23) },
...
ok(dies { Net::DHCPv6::Option::IATA->new },
   'IATA dies without iaid');
ok(dies { Net::DHCPv6::Option::IATA::from_bytes_inner(undef, 4, '') },
   'IATA dies on data < 4 bytes');
...
is($iaprefix->address, $prefix_addr, 'IAPrefix address');
is($iaprefix->preferred_lifetime, 7200, 'IAPrefix preferred');
is($iaprefix->valid_lifetime, 86400, 'IAPrefix valid');
...
is($iaprefix2->address, $prefix_addr, 'parse IAPrefix address');
...
ok(dies { Net::DHCPv6::Option::IAPD->new },
   'IAPD dies without iaid');
ok(dies { Net::DHCPv6::Option::IAPD::from_bytes_inner(undef, 25, "\x01" x 11) },
