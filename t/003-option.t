...
ok( dies { Net::DHCPv6::Option::ORO::from_bytes_inner( undef, 6, "\x01" ) }, 'ORO dies on odd-length data' );
...
ok( dies { Net::DHCPv6::Option::IANA::from_bytes_inner( undef, 3, "\x01" x 11 ) }, 'IANA dies on data < 12 bytes' );
