...
my @data = (
    ['solicit',  pack("H*","011008740001000e000100011c39cf88080027fe8f9500060004001700180008000200000019000c27fe8f9500000e1000001518")],
    ['advertise',pack("H*","021008740019002927fe8f950000000000000000001a00190000119400001c2040200100000000fe0000000000000000000001000e000100011c39cf88080027fe8f950002000e000100011c3825e8080027d410bb")],
    ['request',  pack("H*","0349174e0001000e000100011c39cf88080027fe8f950002000e000100011c3825e8080027d410bb00060004001700180008000200000019002927fe8f9500000e1000001518001a001900001c2000001d4c40200100000000fe000000000000000000")],
    ['reply',    pack("H*","0749174e0019002927fe8f950000000000000000001a00190000119400001c2040200100000000fe0000000000000000000001000e000100011c39cf88080027fe8f950002000e000100011c3825e8080027d410bb")],
    ['release',  pack("H*","08c789b00001000e000100011c39cf88080027fe8f950002000e000100011c3825e8080027d410bb00060004001700180008000200000019002927fe8f950000000000000000001a0019000000000000000040200100000000fe000000000000000000")],
    ['reply2',   pack("H*","07c789b00001000e000100011c39cf88080027fe8f950002000e000100011c3825e8080027d410bb000d0013000052656c656173652072656365697665642e")],
);
...
for my $i (0 .. $#data) {
    ...
    subtest $desc => sub {
        ...
        ok($msg->options->isa('Net::DHCPv6::OptionList'),
            'options is an OptionList');
    };
}
