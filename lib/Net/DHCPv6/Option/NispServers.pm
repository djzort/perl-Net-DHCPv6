...
use Net::DHCPv6::Constants  qw(
    $IPV6_ADDR_LEN $OPTION_NISP_SERVERS
);
...
$Net::DHCPv6::OptionList::OPTION_CLASS{$OPTION_NISP_SERVERS} = __PACKAGE__;
1;
...
=head1 SYNOPSIS
  ...
  my $opt2 = Net::DHCPv6::Option::NispServers->new(
