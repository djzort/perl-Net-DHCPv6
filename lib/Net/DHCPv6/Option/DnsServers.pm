...
use Net::DHCPv6::Constants  qw(
    $IPV6_ADDR_LEN $OPTION_DNS_SERVERS
);
...
sub from_bytes_inner {
    ...
    Net::DHCPv6::X::Truncated->throw( message => 'Truncated DnsServers option' )
...
Carries a list of IPv6 addresses of recursive DNS servers.  See
RFC 3646.
